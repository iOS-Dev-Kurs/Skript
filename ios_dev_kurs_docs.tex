...
Ihr könnt mich jederzeit über meine Email \linkref{n.fischer@stud.uni-heidelberg.de} erreichen.
...
Dieses Skript wird im Verlauf des Semesters im Moodle \linkref{http://elearning2.uni-heidelberg.de/course/view.php?id=3359} kapitelweise zur Verfügung gestellt. Parallel dazu wird es für die Apps, die wir im Rahmen des Kurses erstellen werden, ein weiteres Dokument geben. Dieser \emphc{App-Katalog} wird ebenfalls im Moodle zu finden sein und enthält außerdem die Übungsaufgaben, die wöchentlich zu bearbeiten sind.
