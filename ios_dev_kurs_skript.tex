...
Jeder View Controller ist für die Verwaltung seiner eigenen \strong{Content View} zuständig. \objc{UIViewController} besitzt dafür ein Attribut \objc{UIView *view}.
...
Ähnlich wie bei IBOutlets und IBActions innerhalb einer Scene gibt es mehrere Möglichkeiten, Segues zu erstellen. Dazu gehören bspw. das Ziehen einer Verbindungslinie mit gehaltener \keys{\ctrlkey}-Taste und die Verwendung des 'Triggered Segues' Abschnitts des Connection Inspectors.
