...
Die \objc{main()} Methode wird auch als \strong{Entry Point} bezeichnet und entspricht ihrem Äquivalent in C und C++.
...
Es basiert auf dem Grundsatz, dass \strong{Modell}, \strong{Präsentation} und \strong{Steuerung} strikt getrennt implementiert werden \abbref{img:mvc_diagram}. Durch diese Modularisierung bleibt ein Softwareprojekt flexibel und erweiterbar und einzelne Komponenten können leicht wiederverwertet werden.
